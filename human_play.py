...
def run():
    n = 5
    width, height = 7,7
    model_file = 'current_policy_7_7.model'
    try:
        ...
        best_policy = PolicyValueNet(width, height,training = False, model_file = model_file)
        ...
        game.start_play(human, mcts_player, start_player=random.randint(0,1), is_shown=1)
